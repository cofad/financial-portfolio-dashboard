        ...
        {tabs.map((tab, index) => {
          ...
          return (
            <button
              ...
              className={`-mb-px flex-1 px-3 py-2 text-[16px] font-semibold transition focus-visible:bg-slate-900/60 focus-visible:outline-none sm:min-w-[140px] sm:px-4 sm:py-3 ${
                isActive
